...
package co.edu.uniquindio.poo.veterinariajavafx


import co.edu.uniquindio.poo.veterinariajavafx.model.Animal;
import co.edu.uniquindio.poo.veterinariajavafx.model.Veterianria;
import co.edu.uniquindio.poo.veterinariajavafx.viewcontroller.PrimaryViewController;
import co.edu.uniquindio.poo.veterinariajavafx.viewcontroller.ClienteViewController;
import javafx.application.Application;
import javafx.fxml.FXMLLoader;
import javafx.scene.Scene;
import javafx.scene.layout.AnchorPane;
...
public class App extends Application {
    ...
    public void inicializarData(){
        Cliente cliente = new Cliente("12233", "juan", "perez");
